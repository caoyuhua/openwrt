...
#define RTMP_DRIVER_HWMODE_GET(__pAd, __Hwmode)							\
		RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_SIOCGIWHWMODE, 0, __Hwmode, 0)

#define RTMP_DRIVER_TXPOWER_GET(__pAd, __Txpower)							\
		RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_AP_SIOCGIWTXPOW, 0, __Txpower, 0)
