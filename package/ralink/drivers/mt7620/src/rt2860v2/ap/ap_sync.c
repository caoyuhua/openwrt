	...
	IN PVOID SystemSpecific3)
{
	...
	if (MlmeEnqueue(pAd, AP_SYNC_STATE_MACHINE, APMT2_SCAN_TIMEOUT, 0, NULL, 0)==FALSE)
	{
		DBGPRINT(RT_DEBUG_TRACE,("AP SYNC - APScanTimeout MlmeEnqueue fail\n"));
		APScanCnclAction(pAd, 0);
	}
